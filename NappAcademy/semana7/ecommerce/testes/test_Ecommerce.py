...
<<<<<<< HEAD
    ...
    loja_exemplo = 'Lojão Tabajara'
    loja_filial = 'Lojão Tabajara Centro'

    def test_class_declared(self):
        objeto = Loja(self.loja_exemplo)
        assert isinstance(objeto, Loja)

    def test_instanciar(self):
        objeto = Loja(self.loja_exemplo)
        assert objeto.nome, self.loja_exemplo

    def test_setters(self):
        objeto = Loja(self.loja_exemplo)
        assert objeto.nome == self.loja_exemplo
        objeto.nome = self.loja_filial
=======
    def test_class_declared(self):
...
<<<<<<< HEAD
        objeto = Loja(self.loja_exemplo)
        assert str(objeto) == self.loja_exemplo
        assert repr(objeto) == 'Nome da Loja: '+self.loja_exemplo

    def test_metodo_add_estoque_ok(self):
        loja = Loja(self.loja_exemplo)
...
<<<<<<< HEAD
        loja = Loja(self.loja_exemplo)
        assert loja.comprar('999999') is None
